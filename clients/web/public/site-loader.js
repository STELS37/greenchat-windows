...
(function () {
  ...
  function applyDownloads(data) {
    ...
    var notes = {
      ...
      windows: "Веб/PWA-версия доступна сейчас; нативный установщик готовится.",
    ...
    if (primary && chosen && typeof chosen.url === "string") {
      ...
      if (recommended === "android" || recommended === "linux") primary.setAttribute("download", "");
